...
<html lang="en">
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="card card-outline card-primary" style="background-color: darkslategrey;">
			  	<div class="card-header text-center">
					<a href="#" class="h3 text-white">Administrative Panel</a>
			  	</div>
			  	<div class="card-body">
					...
					<form action="{{route('admin.authenticate')}}" method="post">
		  			...
		  			<!-- <p class="mb-1 mt-3">
				  		<a class="text-white" href="forgot-password.html">I forgot my password</a>
					</p> -->					
			  	</div>
			  	<!-- /.card-body -->
			</div>
