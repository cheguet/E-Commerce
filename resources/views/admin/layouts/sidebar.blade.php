<aside class="main-sidebar  elevation-4" style="background-color:#058348;"><!-- sidebar-dark-primary -->
	<!-- Brand Logo -->
	<a href="#" class="brand-link">
		...
		<span class="brand-text font-weight-light text-white">Boutique Sali</span>
	</a>
	<!-- Sidebar -->
	<div class="sidebar">
			...
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="{{route('brands.index')}}" class="nav-link">
						<svg class="h-6 nav-icon w-6 shrink-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
				...
				<li class="nav-item">
					<a href="{{route('orders.index') }}" class="nav-link">
						<i class="nav-icon fas fa-shopping-bag text-white"></i>
						<p class="text-white">Order</p>
					</a>
				</li>
				<li class="nav-item">
					<a href="{{ route('coupons.index') }}" class="nav-link">
						<i class="nav-icon  fa fa-percent text-white" aria-hidden="true"></i>
				...
				<li class="nav-item">
					<a href="{{route('pages.index')}}" class="nav-link">
						<i class="nav-icon  far fa-file-alt text-white"></i>
