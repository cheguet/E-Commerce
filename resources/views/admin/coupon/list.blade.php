					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{route('coupons.create')}}" class="btn btn-success">New Coupon Code</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
						    ...
						    <form action="" method="get">
							   <div class="card-header">
								   <div class="card-title">
									  <button type="button" onclick="window.location.href='{{route("coupons.index")}}'"  class="btn btn-success btn-sm">Reset</button>
								   </div>
                                      ...
                                      @if ($discountCoupons->isNotEmpty())
                                         @foreach ($discountCoupons as $discountCoupon)
                                            <tr>
                                                ...
                                                <td>{{$discountCoupon->expires_at}}</td>
                                                <td>
