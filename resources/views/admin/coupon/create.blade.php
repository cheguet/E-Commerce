                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="code" id="code" class="form-control" placeholder="Code Coupon">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Name Coupon">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
