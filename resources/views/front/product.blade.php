                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <span class="pt-2 ps-2">({{$product->product_ratings_count}} avis)</span>
                        </div>
                ...
                <div class="col-md-12 mt-5">
                    <div class="bg-light">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="shipping-tab" data-bs-toggle="tab" data-bs-target="#shipping" type="button" role="tab" aria-controls="shipping" aria-selected="false">Expédition & retours</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews" type="button" role="tab" aria-controls="reviews" aria-selected="false">Commentaires</button>
                            </li>
                        </ul>
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        <form action="" method="post" name="productRatingForm" id="productRatingForm"> 
                                            <h3 class="h4 pb-3">Écrire une Critique</h3>
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="">Comment s’est déroulée votre expérience globale ?</label>
                                                <textarea name="comment"  id="comment" class="form-control" cols="30" rows="10" placeholder="Comment s’est déroulée votre expérience globale ?"></textarea>
                                                <p></p>
                                            </div>
                                            <div>
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="overall-rating mb-3">
                                       <div class="d-flex">
                                            ...
                                            <div class="pt-2 ps-2">({{$product->product_ratings_count}} avis)</div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $("#productRatingForm").submit(function(event){
        ...
        $.ajax({
            url: '{{route("front.saveating",$product->id)}}',
            type: 'post',
